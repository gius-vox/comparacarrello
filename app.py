...
# Mappatura ufficiale farmacie con loghi e link corretti
FARMACIE_INFO = {
...
# Logo principale dell'applicazione (mostrato solo se il file esiste davvero)
...
# Visualizzazione barra superiore farmacie
